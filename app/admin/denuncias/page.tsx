...
export default async function AdminDenunciasPage({ searchParams }: { searchParams: AdminSearchParams }) {
  ...
  return <main className="admin-saas-main min-h-screen px-3 py-4 lg:px-5"><div className="mx-auto max-w-6xl"><AdminPageHeader secret={secret} active="denuncias" title="Denúncias" description="Fila pública de denúncias para imagem, link, golpe, marca indevida ou conteúdo ofensivo." />
