...
export default async function AdminEdicoesPage({ searchParams }: { searchParams: AdminSearchParams }) {
  ...
  return <main className="admin-saas-main min-h-screen px-3 py-4 lg:px-5"><div className="mx-auto max-w-6xl"><AdminPageHeader secret={secret} active="edicoes" title="Solicitações de edição" description="Toda edição futura fica pendente até aprovação. O conteúdo atual continua no mural." />
