...
export default async function AdminReservasPage({ searchParams }: { searchParams: AdminSearchParams }) {
  ...
  return (
    <main className="min-h-screen bg-slate-100 px-4 py-6"><div className="mx-auto max-w-6xl"><AdminPageHeader secret={secret} active="reservas" title="Reservas" description="Reservas ativas, travadas e expiradas para limpar sem mexer no grid." />
