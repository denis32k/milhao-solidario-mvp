...
export default async function AdminRelatoriosPage({ searchParams }: { searchParams: AdminSearchParams }) {
  ...
  return <main className="min-h-screen bg-slate-100 px-4 py-6"><div className="mx-auto max-w-6xl"><AdminPageHeader secret={secret} active="relatorios" title="Relatórios e exportação" description="Exportações CSV para conferência, contador, auditoria e controle interno." />
