...
export default async function AdminTermosPoliticasPage({ searchParams }: { searchParams: AdminSearchParams }) {
  ...
  return <main className="min-h-screen bg-slate-100 px-4 py-6"><div className="mx-auto max-w-6xl"><AdminPageHeader secret={secret} active="termos" title="Termos e políticas" description="Versões de Termos, Privacidade e Regras de Conteúdo para rastrear o que o cliente aceitou." />
