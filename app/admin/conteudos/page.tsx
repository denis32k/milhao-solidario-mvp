...
export default async function AdminConteudosPage({ searchParams }: { searchParams: AdminSearchParams }) {
  ...
  return <main className="min-h-screen bg-slate-100 px-4 py-6"><div className="mx-auto max-w-6xl"><AdminPageHeader secret={secret} active="conteudos" title="Conteúdos" description="Fila de publicados sem revisão, aprovados e ocultados. A publicação automática continua, mas o admin revisa depois." />
