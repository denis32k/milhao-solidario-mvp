...
export default async function AdminLgpdPage({ searchParams }: { searchParams: AdminSearchParams }) {
  ...
  return <main className="min-h-screen bg-slate-100 px-4 py-6"><div className="mx-auto max-w-6xl"><AdminPageHeader secret={secret} active="lgpd" title="LGPD e dados do cliente" description="Busca de dados, consentimentos, registros de aceite e solicitações de titular." />
