...
export default async function AdminClientesPage({ searchParams }: { searchParams: AdminSearchParams }) {
  ...
  return <main className="min-h-screen bg-slate-100 px-4 py-6"><div className="mx-auto max-w-6xl"><AdminPageHeader secret={secret} active="clientes" title="Clientes" description="Busca de clientes por nome, nome público, e-mail e WhatsApp, sem expor dados privados no mural público." />
