...
## Versão Admin V2 Base

Esta versão preserva o grid existente e adiciona uma base operacional para testar:

- Dashboard geral do admin com vendas, blocos, reservas, pagamentos, alertas e denúncias.
- Fila de conteúdos publicados sem revisão, usando os conteúdos ativos atuais.
- Área de denúncias com ações rápidas e motivo interno.
- Área de clientes com histórico básico.
- Controle de pagamentos problemáticos no admin.
- Área de testes/dev com Copacabana, Ipanema, Leblon e Tom Delfim Moreira.
- Upload de logo PNG transparente pelo admin.
- Página de transparência atualizada para as áreas atuais.
- Hall da Fama no topo do mural com 1º, 2º e 3º lugar.
- Botões de navegação/zoom no PC com propagação ajustada.

Observação: esta etapa não altera a estrutura do grid. Para sincronizar áreas/preços no banco existente, use:
