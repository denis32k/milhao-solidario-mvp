...
export default function StickyHeader({ ranking = [], active = "mural" }: StickyHeaderProps) {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full border-b border-slate-200/80 bg-[#fffaf2]/98 shadow-[0_8px_24px_rgba(15,23,42,0.06)] backdrop-blur">
      ...
      <Link
        href="/comprar"
        className={`flex h-9 w-full items-center justify-center border-t border-white/60 px-4 text-center text-[13px] font-black tracking-wide text-white transition ${isPurchase ? "bg-gradient-to-r from-orange-500 to-amber-500" : "bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 hover:brightness-105"}`}
      >
